...
pub fn setup_menu(app: &AppHandle) -> tauri::Result<()> {
    ...
    app.on_menu_event(move |app, event| {
        ...
        match id {
            ...
            "view-zoom-in" => eval(app, "document.body.style.zoom = (parseFloat(document.body.style.zoom || '1') + 0.1).toString()"),
            "view-zoom-out" => eval(app, "document.body.style.zoom = Math.max(0.5, parseFloat(document.body.style.zoom || '1') - 0.1).toString()"),
            "view-zoom-reset" => eval(app, "document.body.style.zoom = '1'"),
